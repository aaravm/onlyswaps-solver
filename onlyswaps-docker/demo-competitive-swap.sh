...
echo "  • AggressiveSolver - Executes at 10% down from start price"
echo "  • ModerateSolver - Executes at 33% down from start price"
echo "  • ConservativeSolver - Executes at 50% down from start price"
echo ""
